...
<?php
          ...
          if ($pass != $pass_check) {
            ...
            $kw="SELECT nazwa_uzytkownika from uzytkownicy where nazwa_uzytkownika = '$login';";
            $add = "Insert into uzytkownicy values(NULL,'$login','$pass_hash','prywatnie',NULL,NULL,'example@example.pl','+48000000000',NULL);";
            $con1 = mysqli_query($conn,$kw);
            while($row = mysqli_fetch_row($con1)) {
              $login_check = $row[0];
            }
                  if (empty($login_check)){
                    $add1 = "Insert into uzytkownicy values(NULL,'$login','$pass_hash','prywatnie',NULL,NULL,'example@example.pl','+48000000000',NULL);";
