            ...
            <div class="col-md-4">
                <div class="card text-center p-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="apps_u/stan.php" class="btn btn-primary">Zobacz stan magazynów</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center p-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="apps_u/wys.php" class="btn btn-primary">Zobacz przyjęcia i wydania</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center p-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="apps_u/koszty.php" class="btn btn-primary">sprawdź koszty</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card text-center p-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="apps_u/zlec.php" class="btn btn-primary">Zobacz zlecenia</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center p-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Zmień dane swojego konta.</p>
                        <a href="apps_f/acc_conf.php" class="btn btn-primary">zmień ustawienia</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
